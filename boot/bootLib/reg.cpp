...
uint32_t Reg32_RO::read() const { return *this->reg; }
void Reg32_WO::write(uint32_t value) const { *this->reg = value; }
uint32_t Reg32::read() const { return *this->reg; }
void Reg32::write(uint32_t value) const { *this->reg = value; }
